...
parser = argparse.ArgumentParser(description='To run: python3 animate_pv.py [path_to_cycle_folder] --compare [path_to_cycle_folder_2] --save [output_name]')
...
fig.suptitle('AF simulation: Fast HR, Irregular HR, No atrial contraction')
